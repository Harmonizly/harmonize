...
import { errorMiddleware, notFoundError} from 'auth/middleware/error';
import express from 'express';
import flash from 'connect-flash-plus';
import fs from 'fs';
import https from 'https';
import Logger from 'auth/utils/logger';
import requestLogger from 'auth/middleware/logging';
import process from 'process';
import staticMiddleware from 'auth/middleware/static';
