...
import ErrorMiddleware from 'services/auth/middleware/error';
import Logger from 'services/auth/utils/logger';
import LoggingMiddleware from 'services/auth/middleware/logging';
import StaticMiddleware from 'services/auth/middleware/static';
import swaggerConfig from 'services/auth/config/swagger.yaml';
